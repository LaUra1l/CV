...
navBar.enRoll(".barIcon",".navList","click",170,"fa-solid fa-bars barIcon","fa-solid fa-xmark barIcon");
...
const contactSection=new Navigation(".contactLi",".contactContener","click");
...
const goNextBtn_projectsSection=new Navigation(".projectSection",".contactContener","click");
